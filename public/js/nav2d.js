    ...
    var mouseEventHandler = function (event, mouseState) {
      if (event.nativeEvent.ctrlKey === false && event.nativeEvent.shiftKey === false) {
        if (mouseState === "down") {
          ...
          //   console.log(pose);
          //   var position_input2 = document.getElementById("position_input");
          //   var position_value2 =
          //     pose.position.x +
          //     "/" +
          //     pose.position.y +
          ...
          //     "/" +
          //     pose.orientation.w;
          //   position_input2.setAttribute("value", position_value2);
          // }
          ...
          if (event.nativeEvent.altKey === true) {
            ...
            var position_value =
              pose.position.x + "/" + pose.position.y + "/" + thetaRadians;
            position_input.setAttribute("value", position_value);
          } else if (event.nativeEvent.altKey === false) {
            sendGoal(pose);
          }
        }
      }
